  ...
  return (
    <nav className="flex flex-wrap items-center justify-between p-4 bg-nav text-white w-full">
      ...
      <div className="flex flex-wrap items-center space-x-4 justify-center text-center">
        ...
        {(userRoles.includes('ROLE_ACADEMIC') || userRoles.includes('ROLE_DECANO') || userRoles.includes('ROLE_COORDINADORPOS') || userRoles.includes('ROLE_COORDINADORPRE') || userRoles.includes('ROLE_SUBACADEMIC') || userRoles.includes('ROLE_ADMIN') )&& (
          <>
