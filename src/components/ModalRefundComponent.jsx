...
const ModalRefundComponent = ({ visible, onClose, setDocuments }) => {
        ...
        <div className="modal-backdrop ">
          ...
          >
            <div className="text-center mb-4">
              <h4 className="text-lg font-bold">Carta reembolso - Formato .pdf*</h4>
            </div>
            <div className="grid">
...
ModalRefundComponent.propTypes = {
  visible: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  setDocuments: PropTypes.func.isRequired,
};

export default ModalRefundComponent;
